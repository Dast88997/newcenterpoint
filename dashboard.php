                    ...
                    <div class="card"
                        ...
                        <div class="card-body">
                            <a href="create-flight-ticket.php" style="text-decoration:none;"><i class='fa fa-save'
                                ...
                                <h6 style="padding-top:20px;color:#ffffff;">Create International Flight Ticket Details</h6>
                            </a>
            ...
            <div class="col-md-3">
                <div id="Sign In" align="center">
                    <div class="card"
                        style="width: 12rem;background-color:#534b4f;border:1px solid #534b4f;border-radius:20px;">
                        <div class="card-body">
                            <a href="create-local-ticket.php" style="text-decoration:none;"><i class='fa fa-save'
                                    style='font-size:40px;color:#fbec5d'></i>
                                <h6 style="padding-top:20px;color:#ffffff;">Create Local Flight Ticket Details</h6>
                            </a>
            ...
            <div class="col-md-3">
                <div id="Sign In" align="center">
                    <div class="card"
                        style="width: 12rem;background-color:#534b4f;border:1px solid #534b4f;border-radius:20px;">
                        <div class="card-body">
                            <a href="access-flights.php" style="text-decoration:none;"><i
                                    class='fa fa-file-archive-o' style='font-size:40px;color:#fbec5d'></i>
                                <h6 style="padding-top:20px;color:#ffffff;">View And Update International Flight Ticket</h6>
                            </a>
            ...
            <div class="col-md-3">
                <div id="Sign In" align="center">
                    <div class="card"
                        style="width: 12rem;background-color:#534b4f;border:1px solid #534b4f;border-radius:20px;">
                        <div class="card-body">
                            <a href="access-local-flights.php" style="text-decoration:none;"><i
                                    class='fa fa-file-archive-o' style='font-size:40px;color:#fbec5d'></i>
                                <h6 style="padding-top:20px;color:#ffffff;">View And Update Local Flight Ticket</h6>
                            </a>
