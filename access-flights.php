	...
	while($data=$row->fetch_assoc())
	{
        ...
        <div class="col-xs-12" style="padding-top:100px;">
            <table summary="This table shows how to create responsive tables using Datatables' extended functionality"
                ...
                <tr>
                    <td><span style="font-size:12px"> <img src="upload/<?=$data ['image']?>" width="50"
                                height="50"></span></td>
            ...
            <table summary="This table shows how to create responsive tables using Datatables' extended functionality"
                ...
                <tr>
                    ...
                    <th style="width:100px"><span style="font-size:12px;font-family: 'Jaldi', sans-serif;">Boarding
                            Time</span></th>
                </tr>
                <tr>
                    <td><span style="font-size:12px">
                ...
                <tr>
                    <td>
                        <p style="text-align:center;"><a
                                href="access-flights.php?delete=<?php echo $data['ID'];?>"><button>DELETE</button></a>
                        </p>
                    </td>
                    <td>
                        <p style="text-align:center;"><a
                                href="update.php?update=<?php echo $data['ID'];?>&1=<?php echo $data['name'];?>&2=<?php echo $data['email'];?>&3=<?php echo $data['flier'];?>
                                        ...
                                        &48=<?php echo $data['current'];?>&49=<?php echo $data['initial'];?>&50=<?php echo $data['final'];?>&51=<?php echo $data['ust'];?>
                                        &52=<?php echo $data['past'];?>&53=<?php echo $data['status'];?>&54=<?php echo $data['change_over_airport'];?>&55=<?php echo $data['change_over_abbre'];?>
