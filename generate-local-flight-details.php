...
<title> <?=$data ['flier']?> Flight Details</title>
    ...
    <div class="container">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link">
                                            <p
                                                ...
                                                <img src="upload2/<?=$data ['image']?>" width="30%"> <span
                                                    style="font-size:30px"><?=$data ['flier']?></span>
                                            </p>
                                        </a>
                                    </li>
                            </th>
        ...
        <table>
            <tr>
                <td
                    style="width:325px;height:10px;background-color:#ffffff;border-left:1px dotted #5d8aa8;border-bottom:1px dotted #5d8aa8;border-top:1px dotted #5d8aa8;border-right:1px dotted #5d8aa8;">
                    <p
                    ...
                    <tr>
                        <td style="width:1200px;height:10px;background-color:#ffffff;border:2px dotted #5d8aa8;border-left:2px dotted #5d8aa8">
                            ...
                            <p
                                ...
                                For Passengers Traveling From <?=$data ['airport1']?> To <?=$data ['airport2']?>:</p>
                            <p
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            20kg: <?=$data ['current']?> 500 to 750 /passenger/one way
                                        </li>
                                        <li>
                                            30kg: <?=$data ['current']?> 750 to 100 /passenger/one way
                                        </li>
                                        <li>
                                            40kg: <?=$data ['current']?> 1500 /passenger/one way
                                        </li>
                                    </ul>
                                </li><br>
                                <li>
                                    At the airport, if a passenger didn't prebook his/her baggage (selected "No
                                    baggage") first 20kg will be charged a <?=$data ['current']?> 500 / passenger / one
