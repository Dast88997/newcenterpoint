...
time_arrival,checkin,d_travel,aircraft1,meal1,distance1,carbin,type,
current,initial,final,image,status,airfare,boarding from local where usta='$usta' and pastis='$pastis'";
...
{?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link"
                                    style="color:#fff;font-family: 'Open Sans', sans-serif;font-size:18px;"> <img
                                        ...
                                        width="100" height="100">Welcome:&nbsp <?=$data ['name']?></a>
                            </li>
    ...
    <div class="container">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link">
                                            <p
                                                ...
                                                <img src="upload2/<?=$data ['image']?>" width="100" height="100">
                                            </p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <th
                                    ...
                                    <div id="Sign In" align="left">
                                        <p style="text-align:left;text-indent:3em;padding-top:20px;"> <img
                                                src="Image/plane.png" style="width:30px;height:30px;">
                                            &nbsp<span
                                                style="font-size:18px;font-family: 'Encode Sans', sans-serif;color:#000000;">Date On Arrival: <?=$data ['arr_transit']?></span></p>
                                </th>
            </div>
            <table>
                <tr>
        ...
        <table>
            <tr>
                <td style="width:370px;background-color:#ffffff;border:1px dotted #000000;">
                    <p
                ...
                <td style="width:370px;background-color:#ffffff;border:1px dotted #000000;">
                    <p
                        style="padding-top:20px;font-size:13px;color:#000000;font-family: 'Encode Sans', sans-serif;text-indent:4em;">
                        Boarding Time: <b><?=$data ['boarding']?></b></p>
                </td>
            </tr>
            <table>
    </div>
    ...
    <p style="text-align:center;padding-top:90px;"><a href="generate-local-flight-details.php?email=<?=$email;?>&search=local-flight-details" class="btn btn-success"
            style="width:250px;height:40px;">Print Out Flight Ticket</a></p><br><br>
            <p style="text-align:center"><a href="local-boarding-pass.php?email=<?=$email;?>&search=local-boarding-pass" class="btn btn-success"
